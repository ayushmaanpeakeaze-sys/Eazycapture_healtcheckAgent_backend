...
async def run_batch_health_check(
    ...
    # Capital checks (deterministic) over invoices, bills, bank items + manual
    # journals: low_cost_fixed_asset flags fixed-asset lines too cheap to
    # capitalise; capital_item_review is the Revenue-vs-Capital SOP.
